...
class EmployeeForm(forms.ModelForm):
    # Поле для масового завантаження файлів
    ...
    class Meta:
        ...
        widgets = {
            ...
            'appointment_order_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '№123 від 01.01.2024'}),
            ...
            'dismissal_order_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '№321 від 31.12.2024'}),
    ...
    def clean_rnokpp(self):
        ...
        if rnokpp:
            ...
            if len(rnokpp) != 10:
                raise forms.ValidationError(f"РНОКПП повинен містити рівно 10 цифр.")
        return rnokpp

# ФОРМСЕТ ДЛЯ КЕРУВАННЯ СЕРТИФІКАТАМИ КЕП (Додано)
KepCertificateFormSet = inlineformset_factory(
    Employee, 
    KepCertificate, 
    fields=('file',), 
    extra=1, 
    can_delete=True,
    widgets={'file': forms.FileInput(attrs={'class': 'form-control form-control-sm'})}
)