...
urlpatterns = [
    path('', views.ServiceTaskListView.as_view(), name='service_list'),    path('create/', views.service_create, name='service_create'),
    ...
    path('reports/', views.ServiceReportListView.as_view(), name='report_list'),
